...
| mihomo版本差异 | 配置文件ui设置                        | 备注                                                            |
| :------------: | ------------------------------------- | --------------------------------------------------------------- |
|      1.0      | external-ui: /root/.config/mihomo/ui | 当配置文件插入这一行时自动下载ui面板                            |
|    1.2-yacd    | external-ui: /root/.config/mihomo/ui | 使用yacd-meta面板，已经通过脚本自动<br />设置后台地址，无缝管理 |
|      1.1      | 尚不完整                              |                                                                 |
